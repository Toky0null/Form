...
public class DeleteWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        deteleBtn = new javax.swing.JPanel();
        ...
        title.setText("Eliminar Contacto");
        bg.add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, -1, -1));

        deteleBtn.setBackground(new java.awt.Color(0, 134, 190));

        deleteBtnTxt.setFont(new java.awt.Font("Roboto Condensed", 1, 14)); // NOI18N
        deleteBtnTxt.setForeground(new java.awt.Color(255, 255, 255));
        deleteBtnTxt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        deleteBtnTxt.setText("Eliminar");
        deleteBtnTxt.setToolTipText("");
        deleteBtnTxt.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        javax.swing.GroupLayout deteleBtnLayout = new javax.swing.GroupLayout(deteleBtn);
        deteleBtn.setLayout(deteleBtnLayout);
        deteleBtnLayout.setHorizontalGroup(
            deteleBtnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 130, Short.MAX_VALUE)
            .addGroup(deteleBtnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(deteleBtnLayout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(deleteBtnTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
        deteleBtnLayout.setVerticalGroup(
            deteleBtnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 40, Short.MAX_VALUE)
            .addGroup(deteleBtnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(deteleBtnLayout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(deleteBtnTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );

        bg.add(deteleBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 470, 130, 40));
    ...
    private void deleteBtnTxtMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBtnTxtMouseEntered
        deteleBtn.setBackground(new Color(0, 156, 223));
    ...
    private javax.swing.JPanel deteleBtn;
